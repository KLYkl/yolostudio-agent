...
> 目的：不是凭感觉决定“下一步增强哪个 tool”，而是先回看 `D:\yolodo2.0` 现有项目功能，再把 **GUI / core 已有能力** 映射到 **Agent 当前工具能力**，最后给出更合理的增强方向。
...
如果只看 `D:\yolodo2.0\core` 和 `D:\yolodo2.0\ui`，这个项目已经包含三大业务面：
...
- `D:\yolodo2.0\ui\data_widget\_widget.py`
- `D:\yolodo2.0\core\data_handler\_handler.py`
- 以及相关 mixin：
  - `_scan.py`
  - `_validate.py`
  - `_split.py`
...
- `D:\yolodo2.0\ui\train_widget.py`
- `D:\yolodo2.0\core\train_handler.py`
...
- `D:\yolodo2.0\ui\predict_widget\_widget.py`
- `D:\yolodo2.0\core\predict_handler\_manager.py`
- `D:\yolodo2.0\core\predict_handler\_image_batch.py`
- `D:\yolodo2.0\core\predict_handler\_video_batch.py`
- `D:\yolodo2.0\core\output_manager.py`
- `D:\yolodo2.0\core\camera_scanner.py`
