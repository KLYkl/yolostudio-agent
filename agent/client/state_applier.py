...
def apply_tool_result_to_state(
    ...
    if tool_name == 'scan_dataset' and result.get('ok'):
        ...
        pred.last_inspection = {
            ...
            'prediction_output_overview': result.get('prediction_output_overview'),
        ...
        pred.last_export = {
            'summary': result.get('summary'),
            'mode': result.get('mode'),
            'export_overview': result.get('export_overview'),
            'action_candidates': result.get('action_candidates'),
        ...
        pred.last_path_lists = {
            'summary': result.get('summary'),
            'mode': result.get('mode'),
            'path_list_overview': result.get('path_list_overview') or result.get('export_overview'),
            'action_candidates': result.get('action_candidates'),
        ...
        pred.last_organized_result = {
            'summary': result.get('summary'),
            'mode': result.get('mode'),
            'organization_overview': result.get('organization_overview'),
            'action_candidates': result.get('action_candidates'),
