...
OUT_JSON = TEST_DIR / 'test_prediction_regression_suite_output.json'
OUT_MD = PROJECT_ROOT / 'doc' / 'prediction_regression_report_2026-04-11.md'
WORK = TEST_DIR / '_tmp_prediction_suite'
