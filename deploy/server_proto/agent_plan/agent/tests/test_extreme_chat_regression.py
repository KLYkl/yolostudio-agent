    ...
    async def _fake_direct_tool(tool_name: str, **kwargs: Any) -> dict[str, Any]:
        ...
        if tool_name == "preview_extract_images":
            ...
            result = {
                ...
                "next_actions": ["如需确认训练如何启动，可继续调用 training_preflight"],
            }
            ...
            result = {
                ...
                "blockers": [],
                "warnings": [],
                "next_actions": ["如需真正开始训练，请调用 start_training"],
            }
...
async def _run() -> None:
    ...
    try:
        ...
        assert "prepare_dataset_for_training" in turn3["message"], turn3
        ...
        assert "prepare_dataset_for_training" in turn12["message"], turn12
